...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_pystyy_ostamaan_edullisen_lounaan_kun_kortilla_on_vain_edullisen_lounaan_verran(self):
        self.kortti = Maksukortti(250)
        self.kortti.syo_edullisesti()
        self.assertEqual(self.kortti.saldo_euroina(), 0)
    
    def test_pystyy_ostamaan_maukkaan_lounaan_kun_kortilla_on_vain_maukkaan_verran(self):
